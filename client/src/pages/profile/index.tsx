...
import {
  clearEditPost,
  POST_MODAL_ACTION,
} from "@/redux/reducers/editPostReducer.ts";
...
const ProfilePage = () => {
  ...
  const handleLoadSharePost = () => {
    if (shareCursor != null) {
      ...
      axios
        .get(POST_URL.GET_MY_SHARE_POST_URL, {
          params: {
            cursor: shareCursor,
            limit: 10,
          },
      ...
      <div className="h-full flex flex-1 justify-center text-white">
        <div className="min-w-[640px] w-[80%] my-6">
          <div className="w-full h-full rounded-xl flex flex-col items-center mb-3 bg-[#181818] overflow-y-scroll no-scrollbar">
            <div className="flex w-full p-6">
              <div className="flex flex-1 flex-col justify-center">
                <div className="flex gap-2 items-end">
                  ...
                  <p className=" text-gray-500">@{userData?.tag}</p>
                </div>
                ...
                <div className="flex items-center my-1">
                  ...
                  >
                    {dayjs(userData?.dob).locale(locale).format("DD/MM/YYYY")}
                  </p>
                </div>
              </div>
            ...
            <button
              type="button"
              className="mx-4 rounded-lg border-white border p-2 w-[92%] my-4"
            ...
            <div className="flex w-full mt-2">
              <button
                className="flex flex-1 py-2 justify-center items-center text-xl font-medium"
                type="button"
                style={{
                  color: profileTab == 0 ? "#ffffff" : "#777777",
                  borderBottom:
                    profileTab == 0 ? "2px solid #ffffff" : undefined,
                }}
              ...
              <button
                ...
                type="button"
                style={{
                  color: profileTab == 1 ? "#ffffff" : "#777777",
                  borderBottom:
                    profileTab == 1 ? "2px solid #ffffff" : undefined,
                }}
            ...
            <div
              className="w-full"
              style={{ display: profileTab == 0 ? "block" : "none" }}
            >
            ...
            <div
              className="w-full"
              style={{ display: profileTab == 1 ? "block" : "none" }}
            >
